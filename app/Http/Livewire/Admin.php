...
class Admin extends Component
{
    ...
    public function payMensalidade($id)
    {
        ...
        if ($get_contract->pagas == $get_contract->periodo) {
            ...
            $msg_notification_contrato_inativo = 'Olá! Viemos te avisar que seu plano com a Plataforma ' . config('app.name') . ' acaba de ser inativado, todas as mensalidades foram quitadas e você não possui mais nenhum débito conosco. Para continuar a usar os serviços da nossa plataforma, entre em contato conosco para realizarmos a renovação do seu plano. <a target="_blank" class="verify-font" href="https://api.whatsapp.com/send?phone=' . config('app.wpp') . '&text=Ol%C3%A1!%20Gostaria%20de%20estar%20realizando%20a%20renova%C3%A7%C3%A3o%20do%20meu%20plano%20com%20a%20Plataforma%20' . config('app.name') . '!">Clique aqui</a> para falar com o suporte. Caso tenha alguma dúvida, não hesite em clicar no botão de <b>Ajuda</b> no canto superior direito da tela e falar conosco! Será sempre um prazer te atender. <b>- Equipe ' . config('app.name') . '</b>.';
        ...
        if ($get_contract->is_test == 0) {
            ...
            $msg_notification_mensalidade_paga = 'Olá! Recebemos seu pagamento referente à mensalidade do dia <b style="color: green;">' . $dia_mensalidade_msg . '</b>. Para visualizar os detalhes da mensalidade e imprimir o seu recibo, vá até o menu <b>Minha conta</b> e em seguida <b>></b> <b>Meus planos</b>. Caso tenha alguma dúvida, não hesite em clicar no botão de <b>Ajuda</b> no canto superior direito da tela e falar conosco! Será sempre um prazer te atender. <b>- Equipe ' . config('app.name') . '</b>.';
    ...
    public function estornarPagamento($id)
    {
        ...
        if ($get_contract->pagas < $get_contract->periodo) {
            ...
            if ($get_contract->status != 1) {
                ...
                $msg_notification_contrato_reativo = 'Olá! Sua mensalidade com vencimento no dia <b>' . $venc_mensalidade_ntf . '</b> foi estornada, sendo assim, seu plano que anteriormente estava inativo, voltou a estar ativo até que todas as mensalidades estejam quitadas. Caso tenha alguma dúvida, não hesite em clicar no botão de <b>Ajuda</b> no canto superior direito da tela e falar conosco! Será sempre um prazer te atender. <b>- Equipe ' . config('app.name') . '</b>.';
        ...
        if ($get_contract->is_test == 0) {
            ...
            $msg_notification_mensalidade_estornada = 'Olá! Sua mensalidade com vencimento no dia <b>' . $venc_mensalidade_estornada . '</b> foi estornada. Para realizar o pagamento novamente, vá até o menu <b>Minha conta</b> e em seguida <b>></b> <b>Meus planos</b>, clique no botão pagar e conclua o passo a passo. Caso tenha alguma dúvida, não hesite em clicar no botão de <b>Ajuda</b> no canto superior direito da tela e falar conosco! Será sempre um prazer te atender. <b>- Equipe ' . config('app.name') . '</b>.';
