<div>
    ...
    <div class="div-block-area-4 mb-4">
        ...
        <div class="admin-area">
            ...
            <div class="card">
                ...
                <div class="topo-ico d-flex flex-row align-items-center mb-1">
                    ...
                    <i style="color: #ec4899;" class="fad fa-cash-register fa-fw fa-lg mr-2"></i>
                    
                    <div class="card-topo mr-2">
                        <div style="margin-bottom: 0 !important;" class="title-block f-calc">                                                           
                            Operações de entrada e saída dos usuários
                ...
                <div class="card-topo mt-3 mb-2">
                    <input type="number" wire:model="search_operacao" placeholder="buscar por ID da operação" class="search-input" autocomplete="off">
                ...
                <div wire:target="search_operacao" wire:loading.remove class="card-body px-0 pb-0 table-responsive yampay-scroll">
                        ...
                        <tbody class="t-body">
                            ...
                            <tr style="cursor: pointer;" class="tr-hover" wire:click.prevent="callOperationEdit({{$user_operation_to_edit->id}})">
                                ...
                                <td style="word-wrap: break-word;" class="align-middle">
                                    ...
                                    @if($user_operation_to_edit->tipo == 3)
                                        <span class="categoria">
                                            Retirada
                                        </span>
                                    @else
                                        <span class="categoria">
                                            {{$user_operation_to_edit->category->descricao }}
                                        </span>
                                    @endif
                                ...
                                @if ($user_operation_to_edit->tipo == 1)
                                    <td class="align-middle">
                                        <span style="white-space: nowrap;" class="operacao-entrada">
                                            Movimento de entrada
                                        </span>
                                    </td>
                                @elseif(($user_operation_to_edit->tipo == 0))
                                    <td class="align-middle">
                    ...
                    @else
                        <div class="d-flex flex-column align-items-center justify-content-center">
                            ...
                            @if($search_operacao)
                            <h3 class="my-4 no-results">Nenhuma operação de entrada ou saída encontrada.</h3>
                            @else
                            <h3 class="my-4 no-results">Busque uma operação pelo ID.</h3>
                            @endif
                        </div>
                    @endif
    ...
    <!-- Modal Operação-->
    <div class="modal fade" id="adm-operacao" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="adm-operacaoLabel" aria-hidden="true"
        wire:ignore.self>
        <div class="modal-dialog">
            <div class="modal-content modal-custom">
                <div class="modal-header">
                    <h5 class="modal-title px-3 py-3" id="adm-operacaoLabel">Editar operação</h5>
