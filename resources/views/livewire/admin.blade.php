<div>
    ...
    <div class="page-header d-flex flex-row align-items-center justify-content-between mb-2">
        @if (auth()->user()->is_admin === 1)
            ...
            <div class="div-right-admin d-flex flex-row align-items-center">
                ...
                <a class="btn btn-new" data-toggle="collapse" href="#adminTools" role="button" aria-expanded="false"
                ...
                <div class="collapse ml-2" id="adminTools" wire:ignore.self>
                    <div style="margin-bottom: 0px !important;" class="card card-body">
                        ...
                        <a href="{{ route('register') }}" class="btn btn-new mb-2">
                            + Novo usuário
                        </a>

                        @if ($estado_manutencao == 0)
                            <button wire:key="manut-active" wire:click.prevent="manutencao" wire:loading.attr="disabled"
                                class="btn btn-new mb-2">
                                Ativar manutenção
                            </button>
                        @elseif($estado_manutencao == 1)
                            <button style="user-select: none;" wire:key="manut-disabled" wire:click.prevent="manutencao"
                                wire:loading.attr="disabled" class="btn-maint mb-2">
                                Desativar manutenção
                            </button>
                        @endif

                        <button wire:key="css-clear" wire:click.prevent="clearCssCache()" wire:loading.attr="disabled"
                            class="btn btn-new mb-2">
                            Limpar cache CSS
                            <br>
                            v. {{ $css_cache_version }}
                        ...
                        <div class="dropdown" id="dpd-ntf">
                            ...
                            <button style="user-select: none; width: 100%;" type="button" data-toggle="dropdown"
                                aria-expanded="false" class="btn-maint">
                            ...
                            <div class="dropdown-menu dropdown-vg-totais">
                                ...
                                <div class="d-flex flex-column align-items-center justify-content-center my-1">
                                    ...
                                    <button wire:key="yes-notif-enable" wire:click.prevent="confirmDropdown()"
                                        wire:loading.attr="disabled" class="btn btn-sm btn-primary btn-block">
                                        Sim
                                    </button>

                                    <button wire:key="no-notif-enable" wire:click.prevent="closeDropdown()"
                                        wire:loading.attr="disabled" class="btn btn-sm btn-danger btn-block">
                                        Não
                                    </button>
                    ...
                    <div class="card">
                        ...
                        <div class="topo-ico d-flex flex-row align-items-center mb-1">
                            ...
                            <div class="dropdown" wire:key="drop1">
                                <button style="padding: 5px 5px; color: #666;"
                                    class="btn btn-sm btn-light ml-2 rounded-circle" type="button" id="drop_details1"
                                    data-toggle="dropdown" aria-expanded="false">
                                    <i class="fas fa-ellipsis-v fa-fw fa-lg"></i>
                                </button>
                                <div style="padding: 20px !important; width: 350px !important; max-width: 350px !important; min-width: 350px !important;"
                                    class="dropdown-menu text-uppercase" aria-labelledby="drop_details1">
                        ...
                        <div class="card-topo mt-3 mb-2">
                            <div style="display: inline-flex; cursor: text;" class="div-ttp-user"
                                data-tooltip="Nome, e-mail ou documento" data-flow="right">
                                <input wire:model="search" placeholder="buscar usuário" class="search-input"
                                    autocomplete="off">
                                <i style="cursor: default;" class="fa fa-search"></i>
                            </div>
                        </div>

                        <div wire:target="qtd, search" style="margin-top: 125px; margin-bottom: 125px;" wire:loading
                        ...
                        <div wire:target="qtd, search" wire:loading.remove
                            class="card-body px-0 pb-0 table-responsive yampay-scroll-lg">

                            @if ($users->count())

                                <table style="cursor: default; white-space: nowrap; user-select: none;"
                                    ...
                                    <tbody class="t-body">
                                        ...
                                        @foreach ($users as $user)
                                            ...
                                            <tr @if ($user->is_blocked == 1) style="border: 2px solid #fca5a5 !important;" @endif
                                                class="tr-hover">
                                                ...
                                                <td style="font-size: 14px; font-weight: 500; color: #725BC2;"
                                                    class="align-middle">
                                                ...
                                                <td class="align-middle">{{ $data_criacao }}<br>
                                                    <span class="g-light">há {{ $diferenca }}
                                                        {{ $tempo }}</span>
                                                </td>

                                                <td class="align-middle">
                                                    <span style="font-size: 11px;"
                                                        class="operacao-entrada text-nowrap">{{ $ultimo_login }}</span><br>
                                                    <div class="mt-1">
                                                        <span class="g-light">há {{ $diferenca_log }}
                                                            {{ $tempo_log }}</span>
                                                    </div>
                                                </td>

                                                <td class="align-middle">
                                                    <button wire:click.prevent="openContracts({{ $user->id }})"
                                                        wire:target="openContracts({{ $user->id }})"
                                                        wire:loading.attr="disabled" data-toggle="modal"
                                                        data-target="#showContracts" type="button"
                                                        class="btn btn-new">
                                                ...
                                                <td class="align-middle">
                                                    <div class="div-span-center">
                                                        @if ($user->is_blocked == 0)
                                                            <span style="font-size: 11px"
                                                                class="operacao-entrada text-nowrap">
                                                                Ativo
                                                            </span>
                                                        @elseif ($user->is_blocked == 1)
                                                            <span style="font-size: 11px"
                                                                class="operacao-saida text-nowrap">
                                                                Bloqueado
                                                            </span>
                                                        @endif
                                                    </div>
                                                ...
                                                <td class="align-middle">
                                                    @if ($user->is_blocked == 0)
                                                        <button wire:target="acesso({{ $user->id }})"
                                                            wire:loading.attr="disabled"
                                                            wire:click.prevent="acesso({{ $user->id }})"
                                                            type="button" class="btn btn-bloquear"><i
                                                                class="fad fa-lock fa-fw mr-1"></i>Bloquear</button>
                                                    @elseif ($user->is_blocked == 1)
                                                        <button wire:target="acesso({{ $user->id }})"
                                                            wire:loading.attr="disabled"
                                                            wire:click.prevent="acesso({{ $user->id }})"
                                                            type="button" class="btn btn-desbloquear"><i
                                                                class="fad fa-lock-open-alt fa-fw mr-1"></i>Desbloquear</button>
                                                    @endif
                                                </td>

                                                <td class="align-middle">

                                                    <button wire:key="delUser{{ $user->id }}"
                                                        wire:target="deletarUser({{ $user->id }})"
                                                        wire:loading.attr="disabled"
                                                        wire:click.prevent="deletarUser({{ $user->id }})"
                                                        type="button" class="btn btn-bloquear"><i
                                                            class="fad fa-trash fa-fw mr-1"></i>Deletar</button>
                    ...
                    <div class="card">
                        ...
                        <div class="topo-ico d-flex flex-row align-items-center mb-1">
                            @if ($modalidade_mensalidade === 1)
                                ...
                                <button wire:key="btn1" wire:click.prevent="alternarModalidade(0)"
                                    wire:loading.attr="disabled" class="btn btn-sm btn-outline-danger ml-2 p-1"
                                    data-tooltip="Mensalidades vencidas" data-flow="top">
                            ...
                            @elseif($modalidade_mensalidade === 0)
                                ...
                                <button wire:key="btn2" wire:click.prevent="alternarModalidade(1)"
                                    wire:loading.attr="disabled" class="btn btn-sm btn-outline-success ml-2 p-1"
                                    data-tooltip="Mensalidades à vencer" data-flow="top">
                                    <i class="fas fa-sort-alt fa-fw fa-lg"></i>
                                </button>
                            @endif
                            <div class="dropdown" wire:key="drop2">
                                <button style="padding: 5px 5px; color: #666;"
                                    class="btn btn-sm btn-light ml-2 rounded-circle" type="button"
                                    id="drop_details2" data-toggle="dropdown" aria-expanded="false">
                                    <i class="fas fa-ellipsis-v fa-fw fa-lg"></i>
                                </button>
                                <div style="padding: 20px !important; width: 400px !important; max-width: 400px !important; min-width: 400px !important;"
                                    class="dropdown-menu text-uppercase" aria-labelledby="drop_details2">
                                    <span style="font-size: 13px; font-weight: 600; color: #555;">
                                        Total de mensalidades à vencer:
                                        <span class="ml-1"
                                            style="font-size: 15px; font-weight: 600; color: #725BC2;">
                                    ...
                                    <span style="font-size: 13px; font-weight: 600; color: #555;">
                                        ...
                                        <span class="ml-1"
                                            style="font-size: 15px; font-weight: 600; color: #dc2626;">
                                    ...
                                    <span style="font-size: 13px; font-weight: 600; color: #555;">
                                        ...
                                        <span class="ml-1"
                                            style="font-size: 15px; font-weight: 600; color: #16a34a;">
                        ...
                        @if ($get_mensalidades_vencidas > 0 and $modalidade_mensalidade === 1)
                            <div class="div-ntf-mensalidades-vencidas">
                                <span style="font-size: 14px;"><span style="color: red; font-weight: 500;">ATENÇÃO:
                                    </span>Existem mensalidades vencidas, alterne a aba para visualizar.</span>
                            </div>
                        @endif

                        <div class="card-topo mt-3 mb-2">
                            <input type="number" wire:model="search_mensalidade"
                                placeholder="buscar por ID do usuário" class="search-input" autocomplete="off">
                        ...
                        <div wire:target="search_mensalidade" wire:loading.remove
                            class="card-body px-0 pb-0 table-responsive yampay-scroll-lg">
                                            ...
                                            <tr class="tr-hover @if ($row_mensalidade->status == 1) row-paga @endif">
                                                ...
                                                <td class="align-middle font-desc">
                                                    @if (empty($row_mensalidade->user->documento))
                                                        <span style="color: #dc2626;" class="text-bold">Não
                                                            cadastrado</span>
                                                    @else
                                                ...
                                                <td class="align-middle font-desc">
                                                    @if (empty($row_mensalidade->user->cidade) or empty($row_mensalidade->user->estado))
                                                        <span style="color: #dc2626;" class="text-bold">Não
                                                            cadastrados</span>
                                                    @else
                                                        {{ $row_mensalidade->user->cidade }} -
                                                        {{ $row_mensalidade->user->estado }}
                                                    @endif
                                                </td>
                                                ...
                                                @if ($row_mensalidade->status == 0)
                                                    <td style="font-size: 14px; font-weight: 600; color: #725BC2;"
                                                        class="align-middle">
                                                        Pendente
                                                    </td>
                                                ...
                                                <td style="font-size: 15px; font-weight: 500; color: #01984E;"
                                                    class="align-middle">
                                                    R$ {{ $row_mensalidade_valor }}
                                                </td>

                                                <td style="font-size: 15px; font-weight: 500; color: #2563eb;"
                                                    class="align-middle">
                                                ...
                                                @if ($row_mensalidade->status == 0)
                                                    <td class="align-middle">
                                                        <div wire:key="{{ $row_mensalidade->id . 'p' }}"
                                                            class="div-btns-actions text-center">

                                                            @if ($row_mensalidade->contract->is_test == 0)
                                                                @if (empty($row_mensalidade->user->documento) or
                                                                        empty($row_mensalidade->user->cidade) or
                                                                        empty($row_mensalidade->user->estado))
                                                                    <button
                                                                        data-tooltip="Solicite os dados restantes para pagar a mensalidade."
                                                                        data-flow="left"
                                                                        class="btn btn-secondary btn-sm mr-1" disabled>
                                                                        <i
                                                                            class="far fa-money-bill-alt fa-fw mr-2"></i>Pagar
                                                                    </button>
                                                                @else
                                                                    <button
                                                                        wire:click.prevent="payConfirmation({{ $row_mensalidade->id }})"
                                                                        wire:loading.attr="disabled"
                                                                        wire:target="payConfirmation({{ $row_mensalidade->id }})"
                                                            ...
                                                            <button
                                                                wire:click.prevent="vencimentoConfirmation({{ $row_mensalidade->id }})"
                                                                wire:loading.attr="disabled"
                                                                wire:target="vencimentoConfirmation({{ $row_mensalidade->id }})"
                                                                class="btn btn-warning btn-sm">
                                                                <i
                                                                    class="far fa-money-check-edit-alt fa-fw mr-2"></i>Alterar
                                                                venc.
                                                            </button>
                                                            @if ($row_mensalidade->contract->is_test == 1)
                                                                ...
                                                                @if ($modalidade_mensalidade === 1)
                                                                    <div class="div-space-span mt-2">
                                                                        <span class="operacao-entrada">Período de
                                                                            avaliação ativo</span>
                                                                    </div>
                                                                @elseif($modalidade_mensalidade === 0)
                                                                    <div class="div-space-span mt-2">
                                                                        <span class="operacao-saida">Período de
                                                                            avaliação encerrado</span>
                                                                    </div>
                                                                @endif
                                                            @endif
                                                        </div>
                                                ...
                                                @elseif($row_mensalidade->status == 1)
                                                    <td class="align-middle">
                                                        <div wire:key="{{ $row_mensalidade->id . 'e' }}"
                                                            class="div-btns-actions text-center">

                                                            <button
                                                                wire:click.prevent="estornoConfirmation({{ $row_mensalidade->id }})"
                                                                wire:loading.attr="disabled"
                                                                wire:target="estornoConfirmation({{ $row_mensalidade->id }})"
            ...
            <div class="card">
                ...
                <div class="card-body px-0 pb-0">
                    <div class="d-flex flex-column align-items-center justify-content-center">
                        ...
                        <h3 style="font-size: 30px;" class="my-4 no-results">Área restrita <i
                                class="fad fa-shield"></i></h3>
                        <div class="d-flex flex-column align-items-center justify-content-center mb-4">
                            <h3 style="font-size: 26px;" class="no-results-create mb-3 text-center">Você não possui permissão para
                                visualizar este conteúdo.</h3>
                            <h3 style="font-size: 22px; color: #666;" class="no-results-create mb-3 mt-2">Tem dúvidas?
                            </h3>
                            <a target="_blank"
                                ...
                                class="ml-2 btn btn-nr"><i class="fad fa-user-headset fa-lg mr-2"></i>Fale conosco</a>
                        </div>
                    </div>
                </div>
    ...
    @if (auth()->user()->is_admin === 1)
        ...
        {{-- Modal Planos --}}
        <div class="modal fade" id="showContracts" tabindex="-1" aria-labelledby="showContractsLabel"
                ...
                <div class="modal-content modal-custom">
                    <div class="modal-header">
                        ...
                        <div class="div-fl-modal float-right">
                            <button data-toggle="modal" data-target="#new-contract" type="button"
                                class="btn btn-new my-3">
                                + Novo plano
                            </button>
                        ...
                        @if ($contracts->count())
                            ...
                            <div class="div-qtd-contracts text-uppercase">
                                <span style="font-size: 13px; font-weight: 600; color: #555;">
                                    ...
                                    <span class="ml-1"
                                        style="font-size: 15px; font-weight: 600; color: #725BC2;">{{ $contracts->count() }}</span>
                                </span>
                            </div>
                            ...
                            @foreach ($contracts as $contract)
                                <div class="accordion mt-3" id="accordion{{ $contract->id }}">
                                    <div style="padding: 0px !important; margin-bottom: 0 !important;" class="card">
                                        <div style="background-color: #f9fafb;" class="card-header p-3"
                                            id="heading{{ $contract->id }}">
                                            <h2
                                                class="mb-0 d-flex flex-row align-items-center justify-content-between">
                                                <button style="color: #725BC2;"
                                                    class="btn py-2 btn-link btn-block text-left collapsed font-weight-bold"
                                                    ...
                                                    @if ($contract->is_test == 1)
                                                        [<span style="color: #08af45;">PERÍODO DE AVALIAÇÃO GRATUITA:
                                                            <span style="color: #a855f7;">1 MÊS</span></span>]
                                                ...
                                                <div class="div-accordion-right d-flex flex-row align-items-center">
                                                    ...
                                                    <button style="padding: 4px 7px;"
                                                        class="btn btn-light text-primary text-nowrap" type="button"
                                                        data-toggle="collapse"
                                                        data-target="#contract-info{{ $contract->id }}"
                                                        aria-expanded="false"
                                                        aria-controls="contract-info{{ $contract->id }}">
                                            ...
                                            <div class="collapse" id="contract-info{{ $contract->id }}"
                                                wire:ignore.self>
                                                <div style="margin-bottom: 0 !important; padding: 10px 15px 15px 15px!important;"
                                                    class="card card-body table-responsive yampay-scroll mt-2">

                                                    <table
                                                        style="cursor: default; white-space: nowrap; user-select: none;"
                                                        ...
                                                        <tbody class="t-body">
                                                            ...
                                                            <tr class="tr-hover">
                                                                ...
                                                                <td style="font-size: 14px; font-weight: 500; color: #2563eb;"
                                                                    class="align-middle">
                                                                    {{ $data_contrato }}
                                                                </td>
                                                                ...
                                                                <td style="font-size: 14px; font-weight: 600; color: #2563eb;"
                                                                    ...
                                                                    @if ($contract->comissionado_id != null)
                                                                        @php
                                                                            $get_comissionado = App\Models\User::where('id', $contract->comissionado_id)
                                                                                ->pluck('name')
                                                                                ->toArray();
                                                                        @endphp
                                                                ...
                                                                <td class="align-middle">
                                                                    @if ($contract->status != 3)
                                                                        <div wire:key="{{ $contract->id }}"
                                                                            class="div-key-contract">
                                                                            <button
                                                                                wire:click.prevent="cancelamentoConfirmation({{ $contract->id }})"
                                                                                wire:loading.attr="disabled"
                                                                                wire:target="cancelamentoConfirmation({{ $contract->id }})"
                                                                                class="btn btn-sm btn-outline-secondary mr-1">
                                                                                <i
                                                                                    class="far fa-ban fa-fw mr-1"></i>Cancelar
                                                                                plano
                                                                            </button>
                                                                        </div>
                                                                    @endif
                                                                    @if ($contract->status == 3)
                                                                        @if ($contract->comissionado_id == null)
                                                                            <button
                                                                                wire:click.prevent="exclusaoConfirmation({{ $contract->id }})"
                                                                                wire:loading.attr="disabled"
                                                                                wire:target="exclusaoConfirmation({{ $contract->id }})"
                                                                                class="btn btn-sm btn-danger">
                                                                                <i
                                                                                    class="far fa-trash-alt fa-fw mr-1"></i>Excluir
                                                                                plano
                                                                            </button>
                                                                        @else
                                                                            <button
                                                                                data-tooltip="Não é possível excluir um plano caso haja um comissionado."
                                                                                data-flow="bottom"
                                        ...
                                        <div id="collapse{{ $contract->id }}" class="collapse"
                                            ...
                                            data-parent="#accordion{{ $contract->id }}" wire:ignore.self>
                                                ...
                                                <table style="cursor: default; white-space: nowrap; user-select: none;"
                                                    ...
                                                    <tbody class="t-body">
                                                        ...
                                                        @foreach ($mensalidades as $mensalidade)
                                                            ...
                                                            <tr
                                                                class="tr-hover @if ($mensalidade->status == 1) row-paga @endif">
                                                                    ...
                                                                    <td class="align-middle">
                                                                        <div class="div-btns-actions text-center">
                                                                            <button disabled type="button"
                                                                                ...
                                                                                <i
                                                                                    class="far fa-ban fa-fw mr-2"></i>Cancelado
                                                                            </button>
                                                                        </div>
                                                                    </td>
                                                                @else
                                                                    @if ($mensalidade->status == 0)
                                                                        <td class="align-middle">
                                                                            <div wire:key="{{ $mensalidade->id . 'pag' }}"
                                                                                class="div-btns-actions text-center">

                                                                                <button
                                                                                    wire:click.prevent="payConfirmation({{ $mensalidade->id }})"
                                                                                    wire:loading.attr="disabled"
                                                                                    wire:target="payConfirmation({{ $mensalidade->id }})"
                                                                                    class="btn btn-success btn-sm mr-1">
                                                                                    <i
                                                                                        class="far fa-money-bill-alt fa-fw mr-2"></i>Pagar
                                                                                </button>
                                                                                ...
                                                                                <button
                                                                                    wire:click.prevent="vencimentoConfirmation({{ $mensalidade->id }})"
                                                                                    wire:loading.attr="disabled"
                                                                                    wire:target="vencimentoConfirmation({{ $mensalidade->id }})"
                                                                                    class="btn btn-warning btn-sm">
                                                                                    <i
                                                                                        class="far fa-money-check-edit-alt fa-fw mr-2"></i>Alterar
                                                                                    venc.
                                                                    ...
                                                                    @elseif($mensalidade->status == 1)
                                                                        <td class="align-middle">
                                                                            <div wire:key="{{ $mensalidade->id . 'est' }}"
                                                                                class="div-btns-actions text-center">

                                                                                <button
                                                                                    wire:click.prevent="estornoConfirmation({{ $mensalidade->id }})"
                                                                                    wire:loading.attr="disabled"
                                                                                    wire:target="estornoConfirmation({{ $mensalidade->id }})"
                                                                                    type="button"
                                                                                    class="btn btn-primary btn-sm mr-1">
                                                                                    <i
                                                                                        class="far fa-undo-alt fa-fw mr-1"></i>Estornar
                                                                                </button>
                        ...
                        @else
                            <div class="d-flex flex-column align-items-center justify-content-center">
                                ...
                                <div class="d-flex flex-column align-items-center justify-content-center">
                                    ...
                                    <a data-toggle="modal" data-target="#new-contract" class="ml-2 btn btn-nr">+ Novo
                                        plano</a>
                                </div>
                            </div>
                        @endif
        ...
        <div class="modal fade" data-backdrop="static" data-keyboard="false" id="pay-mensalidade-confirmation"
            tabindex="-1" aria-labelledby="pay-mensalidade-confirmationLabel" aria-hidden="true" wire:ignore.self>
            <div class="modal-dialog">
                <div class="modal-content modal-custom">
                    <div class="modal-header">
                        <h5 class="modal-title px-3 py-3" id="pay-mensalidade-confirmationLabel">Confirmação de
                            pagamento</h5>
                        <button wire:click.prevent="resetOperation()" wire:loading.attr="disabled" type="button"
                            class="close px-4" aria-label="Close" data-dismiss="modal">
                            <i class="fal fa-times"></i>
                        </button>
                    </div>
                    <div class="modal-body py-4 px-4">

                        <h5 class="modal-confirmation-msg m-0 text-center px-4 my-3">Deseja realmente pagar esta
                            mensalidade?</h5>

                        <div class="confirmation-msg text-center mb-3">
                            <p class="m-0 mb-3 px-4">
                                Ao clicar em <span class="msg-bold">Confirmar</span>, a mensalidade será paga para este
                    ...
                    <div class="modal-footer py-4">
                        ...
                        <button wire:click.prevent="payMensalidade({{ $mensalidade_target }})"
                            wire:loading.attr="disabled" type="button" class="btn btn-send" data-dismiss="modal">
                            Confirmar
                        </button>
                    </div>
                </div>
        ...
        <div class="modal fade" data-backdrop="static" data-keyboard="false" id="estorno-mensalidade-confirmation"
            tabindex="-1" aria-labelledby="estorno-mensalidade-confirmationLabel" aria-hidden="true"
            wire:ignore.self>
            <div class="modal-dialog">
                <div class="modal-content modal-custom">
                    <div class="modal-header">
                        <h5 class="modal-title px-3 py-3" id="estorno-mensalidade-confirmationLabel">Confirmação de
                            estorno</h5>
                        <button wire:click.prevent="resetEstorno()" wire:loading.attr="disabled" type="button"
                            class="close px-4" aria-label="Close" data-dismiss="modal">
                            <i class="fal fa-times"></i>
                        </button>
                    </div>
                    <div class="modal-body py-4 px-4">
                        ...
                        <h5 class="modal-confirmation-msg m-0 text-center px-4 my-3">Deseja realmente estornar este
                            pagamento?</h5>

                        <div class="confirmation-msg text-center mb-3">
                            <p class="m-0 mb-3 px-4">
                                Ao clicar em <span class="msg-bold">Confirmar</span>, a mensalidade será estornada para
                                este usuário da plataforma.
                            </p>
                        </div>
                    ...
                    <div class="modal-footer py-4">
                        <button wire:loading.attr="disabled" wire:click.prevent="resetEstorno()" type="button"
                            class="btn btn-cancel" data-dismiss="modal">Cancelar</button>
                        <button wire:click.prevent="estornarPagamento({{ $mensalidade_target }})"
                            wire:loading.attr="disabled" type="button" class="btn btn-send" data-dismiss="modal">
                            Confirmar
                        </button>
                    </div>
        ...
        <div class="modal fade" data-backdrop="static" data-keyboard="false"
            id="vencimento-mensalidade-confirmation" tabindex="-1"
            aria-labelledby="vencimento-mensalidade-confirmationLabel" aria-hidden="true" wire:ignore.self>
            <div class="modal-dialog">
                <div class="modal-content modal-custom">
                    <div class="modal-header">
                        <h5 class="modal-title px-3 py-3" id="vencimento-mensalidade-confirmationLabel">Alterar
                            vencimento</h5>
                        <button wire:click.prevent="resetVencimento()" wire:loading.attr="disabled" type="button"
                            class="close px-4" aria-label="Close" data-dismiss="modal">
                            <i class="fal fa-times"></i>
                        </button>
                    </div>
                    <div class="modal-body py-4 px-4">
                        ...
                        <div class="form-group mb-0">
                            <label class="modal-label" for="desc-op">Data de vencimento <span
                                    class="red">*</span></label>
                            <input style="width: 100%; height: calc(2.25rem + 2px);"
                                wire:model.defer="vencimento_mensalidade" type="date"
                                class="form-control modal-input search-relatorio" id="desc-op" autocomplete="off">
                    ...
                    <div class="modal-footer py-4">
                        <button wire:loading.attr="disabled" wire:click.prevent="resetVencimento()" type="button"
                            class="btn btn-cancel" data-dismiss="modal">Cancelar</button>
                        <button wire:click.prevent="alterarVencimento({{ $mensalidade_target }})"
                            wire:loading.attr="disabled" type="button" class="btn btn-send">
                            Confirmar
                        </button>
                    </div>
                </div>
        ...
        <div class="modal fade" data-backdrop="static" data-keyboard="false" id="cancelamento-contrato"
            tabindex="-1" aria-labelledby="cancelamento-contratoLabel" aria-hidden="true" wire:ignore.self>
            <div class="modal-dialog">
                <div class="modal-content modal-custom">
                    <div class="modal-header">
                        <h5 class="modal-title px-3 py-3" id="cancelamento-contratoLabel">Confirmação de cancelamento
                        </h5>
                        <button wire:click.prevent="resetCancelamento()" wire:loading.attr="disabled" type="button"
                            class="close px-4" aria-label="Close" data-dismiss="modal">
                            <i class="fal fa-times"></i>
                        </button>
                    </div>
                    <div class="modal-body py-4 px-4">
                        ...
                        <h5 class="modal-confirmation-msg m-0 text-center px-4 my-3">Deseja realmente cancelar este
                            plano?</h5>

                        <div class="confirmation-msg text-center mb-3">
                            <p class="m-0 mb-3 px-4">
                                Ao clicar em <span class="msg-bold">Confirmar</span>, este plano será cancelado na
                                Plataforma.
                                <br>
                                <span class="msg-bold text-uppercase">Atenção:</span> Esta ação é irreversível e o
                                plano não poderá ser ativo novamente!
                            </p>
                        </div>
                    ...
                    <div class="modal-footer py-4">
                        <button wire:loading.attr="disabled" wire:click.prevent="resetCancelamento()" type="button"
                            class="btn btn-cancel" data-dismiss="modal">Cancelar</button>
                        <button wire:click.prevent="cancelContract({{ $contrato_target }})"
                            wire:loading.attr="disabled" type="button" class="btn btn-send" data-dismiss="modal">
                            Confirmar
                        </button>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content modal-custom">
                    <div class="modal-header">
                        ...
                        <button wire:click.prevent="resetExclusao()" wire:loading.attr="disabled" type="button"
                            class="close px-4" aria-label="Close" data-dismiss="modal">
                            <i class="fal fa-times"></i>
                        </button>
                    </div>
                    <div class="modal-body py-4 px-4">
                        ...
                        <h5 class="modal-confirmation-msg m-0 text-center px-4 my-3">Deseja realmente excluir este
                            plano?</h5>

                        <div class="confirmation-msg text-center mb-3">
                            <p class="m-0 mb-3 px-4">
                                Ao clicar em <span class="msg-bold">Confirmar</span>, este plano será inteiramente
                                excluído da Plataforma.
                                <br>
                                <span class="msg-bold text-uppercase">Atenção:</span> Esta ação é irreversível e o
                                plano não poderá ser visualizado novamente!
                            </p>
                        </div>
                    ...
                    <div class="modal-footer py-4">
                        <button wire:loading.attr="disabled" wire:click.prevent="resetExclusao()" type="button"
                            class="btn btn-cancel" data-dismiss="modal">Cancelar</button>
                        <button wire:click.prevent="deleteContract({{ $contrato_target }})"
                            wire:loading.attr="disabled" type="button" class="btn btn-send" data-dismiss="modal">
                            Confirmar
                        </button>
                    </div>
        ...
        <div class="modal fade" data-backdrop="static" data-keyboard="false" id="delete-user-confirmation"
            tabindex="-1" aria-labelledby="delete-user-confirmationLabel" aria-hidden="true" wire:ignore.self>
            <div class="modal-dialog">
                <div class="modal-content modal-custom">
                    <div class="modal-header">
                        <h5 class="modal-title px-3 py-3" id="delete-user-confirmationLabel">Confirmação de exclusão
                        </h5>
                        <button wire:click.prevent="resetUserToDeleteInfo()" wire:loading.attr="disabled"
                            type="button" class="close px-4" aria-label="Close" data-dismiss="modal">
                            <i class="fal fa-times"></i>
                        </button>
                    </div>
                    <div class="modal-body py-4 px-4">

                        <h5 class="modal-confirmation-msg m-0 text-center px-4 my-3">Deseja realmente deletar este
                            usuário da plataforma?</h5>

                        <div class="confirmation-msg text-center mb-3">
                            <p class="m-0 mb-3 px-4">
                                Ao clicar em <span class="msg-bold">Confirmar</span>, o usuário <span
                                    class="msg-bold">{{ $username_to_delete }}</span> e todos os seus dados serão
                                inteiramente excluídos da plataforma.
                                <br>
                                <span class="msg-bold text-uppercase">Atenção:</span> Esta ação é irreversível e o
                                usuário não poderá ser recuperado!
                            </p>
                        </div>
                    ...
                    <div class="modal-footer py-4">
                        <button wire:click.prevent="resetUserToDeleteInfo()" wire:loading.attr="disabled"
                            type="button" class="btn btn-cancel" data-dismiss="modal">Cancelar</button>
                        <button wire:click.prevent="confirmDeletarUser()" wire:loading.attr="disabled" type="button"
                            class="btn btn-send" data-dismiss="modal">
                            Confirmar
                        </button>
                    </div>
                </div>
