            ...
            <div class="card">
                ...
                <div class="card-body px-0 pb-0">
                    ...
                    <div class="div-table-options d-flex flex-row align-items-center mb-2">
                        ...
                        @if ($table_scroll == 0)
                            <div style="width: fit-content; user-select: none;" wire:target="toggleTableScroll()"
                                wire:loading.attr="disabled" wire:click.prevent="toggleTableScroll()"
                                data-tooltip="Habilitar" data-flow="right"
                                ...
                                <div class="div-active-scroll">
                                    <span style="font-size: 14px; color: #666; font-weight: 600;"
                                        class="text-uppercase">Barra de rolagem horizontal</span>
                                </div>
                            </div>
                        @elseif($table_scroll == 1)
                            <div style="width: fit-content; user-select: none;" wire:target="toggleTableScroll()"
                                wire:loading.attr="disabled" wire:click.prevent="toggleTableScroll()"
                                data-tooltip="Desabilitar" data-flow="right"
                                class="cbe d-flex flex-row align-items-center">
                        ...
                        <div wire:ignore style="cursor: pointer;" data-toggle="tooltip" data-html="true"
                            ...
                            title="Esta opção ativará uma barra de rolagem horizontal nas tabelas de <b>Visão geral</b>, <b>Fluxo de caixa</b> e <b>Retiradas</b>. Ative esta opção caso o conteúdo da tabela seja muito longo ou esteja transpassando os limites da tela."
                            data-flow="top" class="div-ttp-op-default ml-1">
                    ...
                    <div class="div-table-options d-flex flex-row align-items-center">
                        ...
                        @if ($modal_start === 0)
                            <div style="width: fit-content; user-select: none;" wire:target="notifications(1)"
                                wire:loading.attr="disabled" wire:click.prevent="notifications(1)"
                                data-tooltip="Habilitar" data-flow="right"
                                class="cbe d-flex flex-row align-items-center">
                                <i style="color: #6b7280 !important;"
                                    class="fad fa-toggle-off fa-fw fa-crud fac-edit"></i>
                        ...
                        @elseif($modal_start === 1)
                            <div style="width: fit-content; user-select: none;" wire:target="notifications(0)"
                                wire:loading.attr="disabled" wire:click.prevent="notifications(0)"
                                data-tooltip="Desabilitar" data-flow="right"
                                class="cbe d-flex flex-row align-items-center">
                                <i style="color: #22c55e !important;"
                                    class="fad fa-toggle-on fa-fw fa-crud fac-edit"></i>
                        ...
                        <div wire:ignore style="cursor: pointer;" data-toggle="tooltip" data-html="true"
                            data-placement="bottom"
                            title="Esta opção ativará o pop-up de novidades da Plataforma na <b>Página inicial</b>."
                            data-flow="top" class="div-ttp-op-default ml-1">
                            <i class="fad fa-info-circle fa-fw fa-lg fp-info-ico"></i>
                        </div>
                ...
                @if ($operators_count > 0)
                    ...
                    <div class="d-flex flex-row align-items-center justify-content-start pt-3">
                        ...
                        <button wire:key="op_toggler_active" wire:click.prevent="toggleOperatorTableStatus()"
                            ...
                            class="btn btn-sm mr-0 @if ($sort_operator_status == 0) btn-success @else btn-outline-success @endif"
                            style="border-bottom-right-radius: 0; border-top-right-radius: 0; @if ($sort_operator_status == 0) pointer-events: none; @endif">
                            Ativos ({{ $operators_active_count }})
                        </button>

                        <button wire:key="op_toggler_inactive" wire:click.prevent="toggleOperatorTableStatus()"
                            wire:loading.attr="disabled"
                            class="btn btn-sm mr-2 @if ($sort_operator_status == 1) btn-danger @else btn-outline-danger @endif"
                        ...
                        <table style="cursor: default;" class="table table-borderless">
                            ...
                            <tbody class="t-body">
                                ...
                                @foreach ($operators as $operator)
                                    ...
                                    <tr class="tr-hover"
                                        @if ($operator->status == 1) style="background-color: #fff0f2 !important;" @endif>
                                        <td class="align-middle font-desc">{{ $operator->nome }}</td>
                                        <td class="align-middle font-desc">{{ $operator->senha }}</td>
                                        <td class="align-middle font-desc">
                                            @if ($operator->is_admin === 0)
                                                Funcionário
                                            @elseif($operator->is_admin === 1)
                                                Gerente
                                            @endif
                                        </td>
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex flex-row align-items-center">
                                                ...
                                                @if ($operator->status == 0)
                                                    {{-- EDIT --}}
                                                    <div wire:target="edit({{ $operator->id }})"
                                                        wire:loading.attr="disabled"
                                                        wire:click.prevent="edit({{ $operator->id }})"
                                                        data-toggle="modal" data-target="#editarCat"
                    ...
                    @else
                        <div class="d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex flex-column align-items-center justify-content-center mb-4">
                                ...
                                <a data-toggle="modal" data-target="#operacao" class="ml-2 btn btn-nr">+ Novo
                                    operador</a>
                            </div>
                        </div>
                ...
                <div class="modal-body py-4 px-4">
                    ...
                    <div class="confirmation-msg text-center mb-3">
                        <p class="m-0 mb-3 px-4">
                            Ao clicar em <span class="msg-bold">Confirmar</span>, o nome ou a senha do operador de
                            caixa serão
                            editados na plataforma.
                        </p>
                    </div>
