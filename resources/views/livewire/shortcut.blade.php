                                ...
                                <div class="link-container">
                                    ...
                                    <div class="link-box">
                                        ...
                                        <div class="d-flex flex-row justify-content-end align-items-center">
                                            ...
                                            <div wire:target="prepare({{ $shortcut->id }})" wire:loading.attr="disabled"
                                                wire:click.prevent="prepare({{ $shortcut->id }})" data-toggle="modal"
                                                data-target="#delete-cat-confirmation" data-tooltip="Apagar"
                                                data-flow="right" class="cba">
            ...
            <div class="card">
                ...
                <div wire:target="render, search, qtd, updatingSearch" wire:loading.remove class="card-body px-0 pb-0">
                    <div class="d-flex flex-column align-items-center justify-content-center">
                        ...
                        <h3 class="my-4 no-results">Não há links a serem exibidos.</h3>
                        <div class="d-flex flex-column align-items-center justify-content-center mb-4">
                            <h3 class="no-results-create mb-3">Comece criando um</h3>
                            <a data-toggle="modal" data-target="#operacao" class="ml-2 btn btn-nr">+ Novo link</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content modal-custom">
                <div class="modal-header">
                    <h5 class="modal-title px-3 py-3" id="editarCatLabel">Editar link</h5>
                ...
                <div class="modal-body py-4 px-4">
                    ...
                    <div class="confirmation-msg text-center mb-3">
                        <p class="m-0 mb-3 px-4">
                            Ao clicar em <span class="msg-bold">Confirmar</span>, este link será
                            removido.
                        </p>
                    </div>
