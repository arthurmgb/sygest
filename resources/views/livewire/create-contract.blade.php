                        ...
                        <form wire:submit.prevent="confirmation()">                     
                            ...
                            <div class="form-group mb-0">
                                ...
                                <div class="div-select-comissionado">
                                    <select wire:model="state.comissionado" style="font-size: 16px;" id="comissionado" class="form-control modal-input-cat yampay-scroll" onfocus="this.size=5; this.classList.add('fadeIn'); this.classList.remove('fadeOut');" onblur="this.size=1; this.classList.remove('fadeIn'); this.classList.add('fadeOut');" onchange="this.size=1; this.blur(); this.disabled=true" @if($disable_inputs == 'selected') disabled @endif>
