<div>
    ...
    @elseif($locker == 'unlocked')
        <div class="page-header d-flex flex-row align-items-center mb-2">
            ...
            <div style="user-select: none;" class="ml-auto">
                ...
                <button wire:click.prevent="lock()" wire:loading.attr="disabled"
                    class="btn btn-block-gerenciador my-1">Bloquear gerenciador <i
                        class="fad fa-lock-alt fa-fw ml-1"></i></button>
            </div>
        </div>
    @endif
                ...
                <div class="card">
                    ...
                    <div wire:target="render, search, qtd, updatingSearch" wire:loading.remove
                        ...
                        <div style="user-select: none;"
                            ...
                            <h3 style="font-size: 24px;" class="mt-4 no-results text-center">Esta é uma área restrita
                                protegida com criptografia. <i class="fad fa-lock-alt fa-fw"></i></h3>
                            <div class="d-flex flex-column align-items-center justify-content-center mb-4">
                                <h3 style="font-size: 26px;" class="no-results-create mb-3">
                                    Para continuar, digite sua senha.
                                    <span wire:ignore style="cursor: pointer; font-size: 20px;" class="info-total-cx"
                                        id="tt-info" data-html="true" data-toggle="tooltip"
                                        title="Para sua segurança, o gerenciador de senhas da <b>{{ config('app.name') }}</b> é bloqueado por senha. Esta ferramente te permite cadastrar senhas pessoais com a segurança da criptografia <b><u>bcrypt</u></b>."
                                ...
                                <div style="width: 100%;"
                                    ...
                                    <input
                                        style="@if ($blur == 'yes') -webkit-text-security: disc; @endif max-width: 330px;"
                                        wire:model.defer="pass" wire:keydown.enter="authenticate()"
                                        wire:loading.attr="disabled" type="text" class="form-control modal-input"
                                        placeholder="Digite sua senha" autocomplete="new-password" autofocus>

                                    @if ($blur == 'yes')
                                        <div wire:click.prevent="toggleBlur()" class="div-copy-secret-pass"
                                            data-tooltip="Exibir" data-flow="top">
                                            <i style="color: #0696BD;" class="fad fa-eye fa-fw fa-lg ml-3"></i>
                                        </div>
                                    @elseif($blur == 'no')
                                        <div wire:click.prevent="toggleBlur()" class="div-copy-secret-pass"
                                            data-tooltip="Ocultar" data-flow="top">
                                ...
                                <button wire:click.prevent="authenticate()" wire:loading.attr="disabled"
                                    style="white-space: nowrap;" class="btn btn-new">
                                    Desbloquear <i class="fad fa-lock-open-alt fa-fw ml-1"></i>
                                </button>

                                <h3 style="font-size: 22px; color: #666;" class="no-results-create my-3">Precisa de
                                    ajuda?</h3>
                                <a target="_blank"
                                    ...
                                    class="ml-2 btn btn-nr"><i class="fad fa-user-headset fa-lg mr-2"></i>Fale
                                    conosco</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="links-box" wire:target="render, search" wire:loading.remove>
                        <div class="row" wire:sortable="updatePassOrder" wire:key="keygen">
                            ...
                            @foreach ($secrets as $secret)
                                <div class="col-3" wire:sortable.item="{{ $secret['id'] }}"
                                    ...
                                    <div class="link-container">
                                        ...
                                        <div class="link-box">
                                            ...
                                            <div class="d-flex flex-row justify-content-end align-items-center">
                                                ...
                                                <div style="cursor: help !important;" class="div-link mr-auto"
                                                    data-tooltip="Protegida com criptografia" data-flow="right">
                                                    <i style="color: #3b82f6; cursor: help !important;"
                                                        class="fad fa-lock-alt fa-crud fac-cor"></i>
                                                </div>

                                            </div>

                                            <p style="color: #555555; user-select: none;"
                                                class="link-desc text-center">{{ $secret->descricao }}</p>
                                            ...
                                            <div class="d-flex flex-row justify-content-end align-items-center mt-3">
                                                ...
                                                <div wire:key="{{ 'folder-' . $secret->id }}" wire:loading
                                                    wire:target="openFolder({{ $secret->id }})">
                                                    <i style="color: #725BC2 !important;"
                                                        class="fad fa-spinner-third fa-fw fa-crud fac-edit fa-spin"></i>
                                                </div>

                                                <div wire:key="{{ 'edit-' . $secret->id }}" wire:loading
                                                    wire:target="editSecret({{ $secret->id }})">
                                                    <i style="color: #725BC2 !important;"
                                                        class="fad fa-spinner-third fa-fw fa-crud fac-edit fa-spin"></i>
                                                </div>

                                                <div wire:key="{{ 'delete-' . $secret->id }}" wire:loading
                                                    wire:target="deleteSecret({{ $secret->id }})">
                                                    <i style="color: #725BC2 !important;"
                                                        class="fad fa-spinner-third fa-fw fa-crud fac-edit fa-spin"></i>
                                                </div>

                                                <div wire:click.prevent="openFolder({{ $secret->id }})"
                                                    data-tooltip="Abrir" data-flow="bottom" class="cbe">
                                                    <i style="color: #eab308 !important;"
                                                        class="fas fa-folder-open fa-fw fa-crud fac-edit"></i>
                                                </div>

                                                <div wire:click.prevent="editSecret({{ $secret->id }})"
                                                    data-tooltip="Editar" data-flow="bottom" class="cbe">
                                                    <i class="fad fa-edit fa-fw fa-crud fac-edit"></i>
                                                </div>

                                                <div wire:click.prevent="deleteSecret({{ $secret->id }})"
                                                    data-tooltip="Apagar" data-flow="bottom" class="cba">
        ...
        <div class="modal-dialog">
            <div class="modal-content modal-custom">
                <div class="modal-header">
                    <h5 class="modal-title px-3 py-3 text-truncate" id="folder-secretLabel">
                        {{ $data_pass->descricao ?? null }}</h5>
                    <button wire:click.prevent="resetOpen()" type="button" class="close px-4" data-dismiss="modal"
                        aria-label="Close">
                ...
                <div class="modal-body py-4 px-4">
                    ...
                    <h5 style="font-size: 24px; word-wrap: break-word;"
                        class="modal-confirmation-msg m-0 text-center px-4 mb-3">
                                ...
                                <ul class="list-group list-group-horizontal">
                                    <li class="list-group-item text-left flex-fill list-secret">
                                        <i style="color: #725BC2;"
                                            class="fad fa-user-circle fa-fw mr-2 fa-lg"></i>Login
                                    </li>
                                    <li class="list-group-item text-left list-bank-info flex-fill"
                                        ...
                                        <div class="d-flex flex-row align-items-center justify-content-between">
                                            ...
                                            @if (isset($data_pass))
                                                ...
                                                @if (!is_null($data_pass->login))
                                                    <div wire:click.prevent="showAlert()"
                                                        class="div-copy-secret-log copy-login"
                                                        data-clipboard-target="#login-data-secret"
                                                        data-tooltip="Copiar" data-flow="right">
                                                        <i style="color: #3b82f6;"
                                                            class="fad fa-copy fa-fw fa-lg ml-3"></i>
                                                    </div>
                                                @endif
                                ...
                                <ul class="list-group list-group-horizontal mt-2">
                                    ...
                                    <li class="list-group-item text-left list-bank-info flex-fill"
                                        ...
                                        <div class="d-flex flex-row align-items-center justify-content-between">
                                            ...
                                            <span id="senha-data-secret"
                                                class="@if ($blur == 'yes') blur-secret @endif">
                                            ...
                                            <div class="div-block-secret-pass d-flex flex-row align-items-center">
                                                ...
                                                @if ($blur == 'yes')
                                                    <div wire:click.prevent="toggleBlur()"
                                                        class="div-copy-secret-pass" data-tooltip="Exibir"
                                                        data-flow="top">
                                                        <i style="color: #0696BD;"
                                                            class="fad fa-eye fa-fw fa-lg ml-3"></i>
                                                    </div>
                                                @elseif($blur == 'no')
                                                    <div wire:click.prevent="toggleBlur()"
                                                        class="div-copy-secret-pass" data-tooltip="Ocultar"
                                                        data-flow="top">
                                                        <i style="color: #0696BD;"
                                                            class="fad fa-eye-slash fa-fw fa-lg ml-3"></i>
                                                    </div>
                                                @endif

                                                <div wire:click.prevent="showAlert()"
                                                    class="div-copy-secret-pass copy-senha"
                                                    data-clipboard-target="#senha-data-secret" data-tooltip="Copiar"
                                                    data-flow="right">
                                                    <i style="color: #3b82f6;"
                                                        class="fad fa-copy fa-fw fa-lg ml-2"></i>
                                                </div>
                ...
                <div class="modal-footer py-4 d-flex flex-row align-items-center justify-content-end">
                    <button wire:click.prevent="resetOpen()" type="button" class="btn btn-cancel"
        ...
        <div class="modal-dialog">
            <div class="modal-content modal-custom">
                <div class="modal-header">
                    ...
                    <button wire:click.prevent="resetDelete()" type="button" class="close px-4"
                ...
                <div class="modal-body py-4 px-4">
                    ...
                    <h5 class="modal-confirmation-msg m-0 text-center px-4 my-3">Deseja realmente apagar estes dados de
                        senha?</h5>

                    <div class="confirmation-msg text-center mb-3">
                        <p class="m-0 mb-3 px-4">
                            <span class="msg-bold">Atenção: </span> esta ação é irreversível, após apagados, <span
                                class="msg-bold">estes dados não poderão ser recuperados.</span> Certifique-se de ter
                            estes dados de senha salvos em outro lugar caso necessite consultá-los futuramente.
                        </p>
                    </div>

                    <h5 style="font-size: 22px;" class="modal-confirmation-msg m-0 text-center px-4 my-3">Para apagar,
                        digite sua senha.</h5>

                    <div class="div-deleting-pass px-4">
                        <input style="-webkit-text-security: disc;" wire:model.defer="pass_to_delete"
                            wire:keydown.enter="delete()" wire:loading.attr="disabled" type="text"
                            class="form-control modal-input" placeholder="Digite sua senha"
                            autocomplete="new-password">
                    </div>

                </div>
                <div class="modal-footer py-4">
                    <button wire:click.prevent="resetDelete()" type="button" class="btn btn-cancel"
    ...
    <div class="modal fade" data-backdrop="static" data-keyboard="false" id="edit-secret" tabindex="-1"
        aria-labelledby="edit-secretLabel" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog">
            <div class="modal-content modal-custom">
                <div class="modal-header">
                    <h5 class="modal-title px-3 py-3" id="edit-secretLabel">Editar senha</h5>
                    <button wire:click.prevent="resetEdit()" type="button" class="close px-4" data-dismiss="modal"
                        aria-label="Close">
                        <i class="fal fa-times"></i>
                    </button>
                </div>
                <div class="modal-body py-4 px-4">
                    ...
                    <form wire:submit.prevent="update()">
                        ...
                        <div class="form-group">
                            ...
                            <input wire:model.defer="data_pass_edit.descricao" type="text"
                        ...
                        <div class="form-group">
                            <label class="modal-label" for="desc-op">Login <span
                                    style="font-size: 13px;">(opcional)</span></label>
                            <input wire:model.defer="data_pass_edit.login" type="text"
                                class="form-control modal-input" id="desc-op" autocomplete="off"
                                placeholder="E-mail, usuário, conta...">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="d-flex flex-row align-items-center">
                                <input @if ($blur == 'yes') style="-webkit-text-security: disc;" @endif
                                    wire:model.defer="data_pass_edit.senha" type="text"
                                    class="form-control modal-input" id="desc-op" autocomplete="off">
                                @if ($blur == 'yes')
                                    <div wire:click.prevent="toggleBlur()" class="div-copy-secret-pass"
                                        data-tooltip="Exibir" data-flow="top">
                ...
                <div class="modal-footer py-4">
                    ...
                    <button wire:key="btn-cad-secret" wire:loading.attr="disabled" wire:target="update"
                        type="submit" class="btn btn-send">Editar</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content modal-custom">
                <div class="modal-header">
                    ...
                    <button wire:click.prevent="resetEditOnConfirmation()" type="button" class="close px-4"
                        data-dismiss="modal" aria-label="Close">
                        <i class="fal fa-times"></i>
                    </button>
                </div>
                <div class="modal-body py-4 px-4">
                    ...
                    <h5 class="modal-confirmation-msg m-0 text-center px-4 my-3">Deseja realmente editar estes dados de
                        senha?</h5>

                    <div class="confirmation-msg text-center mb-3">
                        <p class="m-0 mb-3 px-4">
                            <span class="msg-bold">Atenção: </span> esta ação é irreversível, após editados, <span
                                class="msg-bold">estes dados não poderão ser revertidos.</span> Certifique-se de ter
                            estes dados de senha salvos em outro lugar caso necessite recuperá-los futuramente.
                        </p>
                    </div>

                    <h5 style="font-size: 22px;" class="modal-confirmation-msg m-0 text-center px-4 my-3">Para editar,
                        digite sua senha.</h5>

                    <div class="div-deleting-pass px-4">
                        <input style="-webkit-text-security: disc;" wire:model.defer="pass_to_edit"
                            wire:keydown.enter="finishUpdate()" wire:loading.attr="disabled" type="text"
                            class="form-control modal-input" placeholder="Digite sua senha"
                            autocomplete="new-password">
                    </div>
                ...
                <div class="modal-footer py-4">
                    <button wire:click.prevent="resetEditOnConfirmation()" type="button" class="btn btn-cancel"
                        data-dismiss="modal">Cancelar</button>
