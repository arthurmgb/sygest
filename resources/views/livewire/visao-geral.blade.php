                                        ...
                                        @foreach ($operations as $operation)
                                                ...
                                                <td class="align-middle text-center">
                                                    @if ($operation->is_venda === 1)
                                                        <div class="toggleCollapseIcon" style="cursor: pointer;"
                                                            ...
                                                            <i
                                                                class="fad fa-minus-circle fa-fw fa-2x icon-info-cod"></i>
                                                        </div>
                                                    @endif
                                                </td>
                                                <td class="align-middle">
                                            ...
                                            <tr wire:ignore.self class="collapse bg-light"
                                                ...
                                                <td class="p-4" colspan="12">
                                                    ...
                                                    <table
                                                        class="table table-striped table-hover table-sm mini-table border mb-3">
                                                        <thead>
                                                            <tr>
                                                    ...
                                                    <table
                                                        class="table table-striped table-hover table-sm mini-table border mb-0">
                                                        <thead>
                                                            <tr>
                                                                <th scope="col" width="20" class="px-3">
                                                                </th>
        ...
        <div class="modal-dialog">
            <div class="modal-content modal-custom">
                <div class="modal-header">
                    ...
                    <button type="button" class="close px-4" data-dismiss="modal" wire:click.prevent="resetDelete()" aria-label="Close">
                        <i class="fal fa-times"></i>
                    </button>
                </div>
                <div class="modal-body py-4 px-4">
                ...
                <div class="modal-footer py-4">
                    <button type="button" class="btn btn-cancel" data-dismiss="modal" wire:click.prevent="resetDelete()">Cancelar</button>
