        ...
        <div class="modal-dialog">
            <div class="modal-content modal-custom">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="d-flex flex-row align-items-center">
                                <input @if ($blur == 'yes') style="-webkit-text-security: disc;" @endif
                                    wire:model.defer="state.senha" type="text" class="form-control modal-input"
                                    id="desc-op" autocomplete="off">
                                @if ($blur == 'yes')
                ...
                <div class="modal-footer py-4">
                    ...
                    <button wire:key="btn-cad-secret" wire:loading.attr="disabled" wire:target="confirmation"
                        type="submit" class="btn btn-send">Cadastrar</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content modal-custom">
                ...
                <div class="modal-body py-4 px-4">
                    ...
                    <h5 class="modal-confirmation-msg m-0 text-center px-4 my-3">Deseja realmente cadastrar estes dados
                        de senha?</h5>

                    <div class="confirmation-msg text-center mb-3">
                        <p class="m-0 mb-3 px-4">
                            Ao clicar em <span class="msg-bold">Confirmar</span>, estes dados de senha serão cadastrados
                            na Plataforma e ficarão disponíveis para consulta a qualquer momento, desde que você informe
                            corretamente a senha de sua conta.
                        </p>

                        <p class="m-0 mb-3 px-4">
                            <span class="msg-bold">Observação: </span> as informações que você cadastrar estarão sempre
                            protegidas na <b>{{ config('app.name') }}</b>, no entanto, certifique-se sempre de escolher
                            uma senha forte para suas contas pessoais. Nossa equipe nunca solicitará a senha de sua
                            conta na Plataforma, guarde-a com segurança para ter acesso a esta ferramenta sempre que
                            precisar consultar uma de suas senhas pessoais.
                        </p>
                    </div>
