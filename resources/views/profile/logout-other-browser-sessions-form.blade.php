<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600 f14-666">
            {{ __('Se necessário, você pode sair de todas as outras sessões de navegador em todos os seus dispositivos. Algumas de suas sessões recentes estão listadas abaixo.') }}
        </div>
        ...
        <div class="flex items-center mt-5">
            <x-jet-button class="primezze-btn" wire:click="confirmLogout" wire:loading.attr="disabled">
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                ...
                <div class="mt-4" x-data="{}" x-on:confirming-logout-other-browser-sessions.window="setTimeout(() => $refs.password.focus(), 250)">
                    <x-jet-input style="width: 490px !important;" type="password" class="primezze-input mt-1 block w-3/4"
                                ...
                                wire:keydown.enter="logoutOtherBrowserSessions" autocomplete="off" />
            ...
            <x-slot name="footer">
                <x-jet-secondary-button class="primezze-btn2" wire:click="$toggle('confirmingLogout')" wire:loading.attr="disabled">
                    {{ __('Cancelar') }}
                </x-jet-secondary-button>

                <x-jet-button class="ml-2 primezze-btn"
