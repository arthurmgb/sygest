...
@section('body')
    ...
    $get_operator_auth = session('operador_selecionado');
            ...
            <div class="d-flex flex-column align-items-center justify-content-center px-4 py-5">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="211"
                    ...
                    <g fill="none" fill-rule="evenodd">
                        <path d="M53.803 136.846h122.8m3.907 0h5.58m-141.207 0h5.58m138.977 0h1.674m-150.696 0h1.674"
                            class="C D E" />
                        ...
                        <rect fill-opacity=".7" fill="#e6e9ec" x="75.291" y="32.893" width="71.86" height="71.86"
                            rx="11.498" class="F" />
                        <path
                        ...
                        <path d="M85.828 39.033c-2.26 1.377-3.86 3.128-4.802 5.253" stroke="#fff" stroke-width="3.349"
                            class="C" />
                ...
                <h3 style="font-size: 20px;" class="my-4 no-results text-center">Estamos em manutenção, em breve
                    retornaremos.</h3>
                <div class="d-flex flex-column align-items-center justify-content-center mb-4">
                    ...
                    <a class="btn btn-default btn-logout btn-block my-4" href="#"
    ...
    @elseif($estado === 0 or auth()->user()->is_admin == 1)
        @if (auth()->user()->is_blocked == 0)
            ...
            <div class="wrapper">
                ...
                <div style="background-color: #f3f4f6;"
                    class="content-wrapper {{ config('adminlte.classes_content_wrapper') ?? '' }}">
        ...
        @else
            <div class="maintence">
                <div class="d-flex flex-column align-items-center justify-content-center px-4 py-5">
                    ...
                    <h3 style="font-size: 22px;" class="my-4 no-results text-center">Ops! Parece que sua mensalidade
                        venceu e seu acesso à plataforma expirou :(</h3>
                    <div class="d-flex flex-column align-items-center justify-content-center mb-4">
                        ...
                        <a style="width: 200px;" class="btn btn-default btn-logout btn-block my-4" href="#"
                            onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                            <i class="fas fa-fw fa-sign-out-alt"></i>
                            Sair
                        </a>
        ...
        <div class="mobile">
            <div style="width: 100%;" class="d-flex flex-column align-items-center justify-content-center px-4 py-5">
                ...
                <a style="padding: 7px 80px;" class="btn btn-default btn-logout my-4" href="#"
                    onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    <i class="fas fa-fw fa-sign-out-alt"></i>
                    Sair
                </a>
