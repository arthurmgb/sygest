@if (auth()->user()->is_admin == 1)
    <li class="nav-item">
        <a style="color: #D4D4DF;" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" title="Administrador"
            class="nav-link pl-1" href="{{ route('admin') }}" role="button">
...
@livewire('bell')
<li class="nav-item">
    <a style="color: #D4D4DF;" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" title="Configurações"
        class="nav-link pl-1" href="{{ route('configuracoes') }}" role="button">
        <i class="fal fa-cog fa-lg"></i>
    </a>
</li>
<li class="nav-item mr-2">
    <a style="color: #D4D4DF;" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" title="Ajuda"
        class="nav-link pl-1"
