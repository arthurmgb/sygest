...
return [
    ...
    */
    ...
    'classes_body' => '',
    'classes_brand' => 'text-white border-0',
    'classes_brand_text' => '',
    'classes_content_wrapper' => 'border-left',
    'classes_content_header' => '',
    'classes_content' => '',
    'classes_sidebar' => 'sidebar-light-purple',
    'classes_sidebar_nav' => 'nav-flat nav-legacy',
    'classes_topnav' => 'navbar-dark border-0',
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Página inicial',
            'route'  => 'home',
            'icon' => 'far ml-2 mr-3 fa-home-alt fa-lg fa-fw',
        ],
        [
            'text' => 'Visão geral',
            'route'  => 'geral',
        ...
        [
            'text' => 'Fluxo de caixa',
            'route'  => 'caixa',
            'icon' => 'far ml-2 mr-3 fa-cash-register fa-lg fa-fw',
        ],
        [
            'text' => 'Retiradas',
            'route'  => 'retiradas',
            'icon' => 'far ml-2 mr-3 fa-wallet fa-lg fa-fw',
        ],
        [
            'text' => 'Relatórios',
            'route'  => 'relatorios',
            'icon' => 'far ml-2 mr-3 fa-file-alt fa-lg fa-fw',
        ],
        [
            'text' => 'Categorias',
            'route'  => 'categorias',
